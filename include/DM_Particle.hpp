...
class DM_Particle
{
  ...
  public:
	...
	virtual double dSigma_dq2_Electron(double q, double vDM) const
	{
		return 0.0;
	};
	...
	//Cross sections
	virtual double Sigma_Proton() const
	{
		return 0.0;
	};
	virtual double Sigma_Neutron() const
	{
		return 0.0;
	};
	virtual double Sigma_Electron() const
	{
		return 0.0;
	};
